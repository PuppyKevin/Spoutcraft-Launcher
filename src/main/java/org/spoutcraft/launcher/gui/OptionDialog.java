...
public class OptionDialog extends JDialog implements ActionListener {
	...
	public OptionDialog() {
		setTitle("TetraVerse Launcher Settings");
		...
		buildInfo.setText("TetraVerse Launcher Build " + Main.build);
		buildInfo.setOpaque(true);
		buildInfo.setForeground(Color.DARK_GRAY);
		buildInfo.setToolTipText("Created by the Spout Development Team and Modified by the TetraVerse Team. Licensed under the LGPL. Source code is available at www.github.com/SpoutDev");

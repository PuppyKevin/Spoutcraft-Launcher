...
public class LoginForm extends JFrame implements ActionListener, DownloadListener, KeyListener, WindowListener {
    ...
    public LoginForm() {
        ...
        JLabel wikiLink = new HyperlinkJLabel("<html><u>Tetraverse Website</u></html>", "http://playtetraverse.com/");
    ...
    public void loadLauncherData() {
        ...
        if (SettingsUtil.getModPackSelection() != null) {
            ...
            setTitle("Tetraverse Launcher - No Modpack Selected");
        }
    }
    ...
    public void updateBranding() {
        ...
        SwingWorker<Object, Object> updateThread = new SwingWorker<Object, Object>() {
            ...
            protected void done() {
                ...
                setTitle(String.format("Tetraverse Launcher - %s - (%s)", Main.build, ModPackListYML.currentModPackLabel));
    ...
    public void windowClosed(WindowEvent e) {
        if (success == LauncherFrame.ERROR_IN_LAUNCH) {
            Util.log("Exiting the Tetraverse Launcher");
            System.exit(0);
        }
    }
